...
public class OdpsMetaClientImpl implements DataSourceMetaClient {
    ...
    public List<Column> describeTable(CloudDataSource dataSource, String database, String tableName) {
        try {
            ...
            log.warn("odps describeTable {} {} {} Exception:", JSON.toJSONString(dataSource), database, tableName, e);
    ...
    public List<String> showDatabases(CloudDataSource dataSource) {
        try {
            ...
            log.warn("odps showDatabases {} Exception:", JSON.toJSONString(dataSource), e);
    ...
    public List<String> showTables(CloudDataSource dataSource, String database, String keyword) {
        try {
            ...
            log.warn("odps showTables {} Exception:", JSON.toJSONString(dataSource), e);
    ...
    public Boolean isPartitionTable(CloudDataSource dataSource, String database, String tableName) {
        try {
            ...
            log.warn("odps isPartitionTable {} Exception:", JSON.toJSONString(dataSource), e);
    ...
    public List<Map<String, Object>> sampleDateForPartition(
        ...
        try {
            ...
            log.warn("odps sampleDateForPartition {} {} {} {} {} Exception:", JSON.toJSONString(dataSource), dataSourceId, partitionStr, bizDate, limit, e);
    ...
    public Boolean hasPartition(
        ...
        try {
            ...
            log.warn("odps hasPartition {} {} {} {} Exception:", JSON.toJSONString(dataSource), dataSourceId, partitionStr, bizDate, e);
    ...
    public Long getRecordCount(
        ...
        try {
            ...
            log.warn("getRecordCount {} {} {} {} Exception:", JSON.toJSONString(dataSource), dataSourceId, partitionStr, bizDate, e);
    ...
    public List<String> getAllPartitions(CloudDataSource dataSource, String dataSourceId) {
        ...
        try {
            ...
            log.warn("odps getAllPartitions {} {} Exception:", JSON.toJSONString(dataSource), dataSourceId, e);
