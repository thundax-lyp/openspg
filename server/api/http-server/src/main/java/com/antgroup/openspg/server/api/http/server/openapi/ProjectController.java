                ...
                new HttpBizCallback<Project>() {
                    ...
                    public Project action() {
                        ...
                        if (request.getAutoSchema() == null || Boolean.TRUE.equals(request.getAutoSchema())) {
                            ...
                            request.setSchemaDraft(SchemaController.getDefaultSchemaDraft(project.getNamespace()));
                ...
                new HttpBizCallback<List<Project>>() {
                    ...
                    public List<Project> action() {
                        ...
                        projectList.forEach(project -> {
                            ...
                            if (configJson != null) {
                                ProjectController.this.configManager.backwardCompatible(configJson);
                                config = configJson.toJSONString();
                            }

                            newProjectList.add(new Project(
                                    project.getId(),
                                    project.getName(),
